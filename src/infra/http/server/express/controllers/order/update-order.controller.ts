...
import {
  InputOrder,
  IOrderService,
} from "../../../../../../core/app/interfaces/services/order";
import { Controller, HttpMethod, ResponseType } from "../controler";

/**
 * @swagger
 * /orders/adding/{orderId}:
 *   put:
 *     tags:
 *       - Orders
...
export class UpdateOrderController implements Controller {
  ...
  getHandler(): (
    request: Request<{ orderId: string }, {}, InputOrder>,
    ...
    return async (request, response): Promise<void> => {
      try {
        ...
        const updated = await this.service.adding({ products, orderId: orderId });
